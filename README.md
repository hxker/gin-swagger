...
1. Add comments to your API source code, [See Declarative Comments Format](https://github.com/hxker/swag/blob/master/README.md#declarative-comments-format).
2. Download [Swag](https://github.com/hxker/swag) for Go by using:

```sh
go get -u github.com/hxker/swag/cmd/swag
```

Starting in Go 1.17, installing executables with `go get` is deprecated. `go install` may be used instead:

```sh
go install github.com/hxker/swag/cmd/swag
```

3. Run the [Swag](https://github.com/hxker/swag) at your Go project root path(for instance `~/root/go-peoject-name`),
   [Swag](https://github.com/hxker/swag) will parse comments and generate required files(`docs` folder and `docs/doc.go`)
